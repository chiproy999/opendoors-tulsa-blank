...
const OpportunitiesCallout = () => {
  return (
    <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-800 to-blue-700 text-white">
          ...
          <div className="text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row justify-center md:justify-start gap-4">
              <Link to="/auth/register?type=employer">
                <Button className="bg-white text-blue-800 hover:bg-gray-100 px-8 py-3 text-lg font-medium">
                  I'm an Employer
                </Button>
              </Link>
              <Link to="/auth/register?type=landlord">
                <Button className="bg-blue-500 hover:bg-blue-600 px-8 py-3 text-lg font-medium border border-white/20">
                  I'm a Landlord
                </Button>
              </Link>
            </div>
